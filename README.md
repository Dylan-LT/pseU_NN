...
#### predictor.py
```
usage: predictor.py [-h] [-i INPUT_FOLDER] [--model MODEL] [-o OUTPUT] [--batch_size BATCH_SIZE] [--len LEN] [--bed BED]
                    [--subsample_number SUBSAMPLE_NUMBER] [--device DEVICE]
...
```
# run predictor.py
python predictor.py -i data/test1/bpseq/ --bed data/test1/test.bed -o data/test1/test --device cuda:0 --len 20 --model model41nt.pth
# run scanner.sh
